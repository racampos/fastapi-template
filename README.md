...
[![codecov](https://codecov.io/gh/racampos/fastapi-template/branch/main/graph/badge.svg?token=fastapi-template_token_here)](https://codecov.io/gh/racampos/fastapi-template)
[![CI](https://github.com/racampos/fastapi-template/actions/workflows/main.yml/badge.svg)](https://github.com/racampos/fastapi-template/actions/workflows/main.yml)

Awesome fastapi_template created by racampos

## Install

from source
```bash
git clone https://github.com/racampos/fastapi-template fastapi_template
cd fastapi_template
make install
```
